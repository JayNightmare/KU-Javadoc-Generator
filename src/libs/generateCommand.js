...
export default async function generateJavadocCommand(uri, silent = false) {
    ...
    try {
        ...
        const prompt = [
            ...
            "- Begin by providing a brief overall description of the file's purpose.",
            "- Then, the authors name (username) should be included using the @author tag.",
            "",
            "Javadoc content guidelines:",
            "- Base all descriptions strictly on the code and names; avoid speculation.",
            "- Use clear, concise language appropriate for professional Java documentation.",
